export IDC_LOGIN_URL=https://d-90123dxxxx.awsapps.com/start
export REGION=us-east-1
export TEAM_ACCOUNT=123456789101
export ORG_MASTER_PROFILE=org_master_profile
export TEAM_ACCOUNT_PROFILE=team_account_profile
